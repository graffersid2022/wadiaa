    ...
    <Box sx={{ height: "100vh" }}>
      ...
      <Box sx={{ mt: 15, display: "flex", justifyContent: "center" }}>
        <Box
          ...
          className="business-registration"
        >
          <Box sx={{ display: "flex", alignItems: "center" }}>
            <Box sx={{ mr: 10 }}>
              <img src={Business} alt="image" style={{ width: "115px" }} />
              <Box sx={{ textAlign: "center", fontSize: '24px' }}>Individual</Box>
            </Box>
            <Box >
              <Box sx={{ fontSize: "24px" }}>Select Individual Investor type</Box>
              <RadioGroup
...
export default InvestIndividual